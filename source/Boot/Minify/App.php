...
if(strpos(url(), "localhost")){  //STRPOS - (se dentro da 'variavel/func', existe a palavra "localhost")->:bool
    ...
    foreach ($cssDir as $value) {
        $cssFile = __DIR__ . "/../../../themes/" . CONF_VIEW_APP . "/assets/css/{$value}";
    ...
    $minifiedPathCss = "/../../../themes/" . CONF_VIEW_APP . "/assets/style.css";
    ...
    foreach ($jsDir as $value) {
        $jsFile = __DIR__ . "/../../../themes/". CONF_VIEW_APP . "/assets/js/{$value}";
    ...
    $minifiefPathJS = "/../../../themes/" . CONF_VIEW_APP . "/assets/scripts.js";
